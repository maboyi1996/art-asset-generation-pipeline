...
合并资产别名，生成稳定资产 ID、状态 ID、任务草稿、人物候选去向台账和分集映射草稿。
...
不重新抽取资产、不重新拆状态、不重新评级。人物候选去向台账只登记候选人物的最终去向，不建立脸模锚点、不生成提示词。B/C 人物不需要项目级锚点，但必须有生产、状态、模板、别名、分组、排除、非视觉或人工审核去向。分集映射只引用全局任务草稿中的 `task_id`。
