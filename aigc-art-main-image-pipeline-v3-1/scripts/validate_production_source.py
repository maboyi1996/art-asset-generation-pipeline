#!/usr/bin/env python3
"""Validate V3.1 production-source/main-image-production-table.md."""
...
def validate_lean_source(path: Path) -> List[str]:
    ...
    try:
        build_manifest(path, content_id=None, project_title=None, skill_id="aigc-art-main-image-pipeline-v3-1", skill_version="3.1")
...
def main(argv: List[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Validate V3.1 production source table")
