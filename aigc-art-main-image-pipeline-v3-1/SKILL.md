---
name: aigc-art-main-image-pipeline-v3-1
description: "当 Codex 需要读取中文剧本、小说草稿、分集短剧脚本或项目剧本文档，并为人物、场景、道具生成忠于剧本证据的 AIGC 主图资产任务时使用本技能。V3.1 输出 manifest 路由的项目文件夹、分层 audit 产物、production-source 生产源、Seedance JSON 和人审 DOCX；prompt 先填 core-prompt slots，再由脚本确定性渲染；可见 C 级角色独立生成 text_to_image 任务。"
---
