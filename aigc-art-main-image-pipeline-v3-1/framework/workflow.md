...
每个层级必须产出明确结果；后续层不得重新切场、不得重做其他层判断。V3.1 沿用 V3.1 的三类证据账本、评级、S/A 状态规则、中文 core prompt、DOCX 人审交付和 C 级可见角色独立任务口径，并新增 artifact manifest 路由、分层中间产物文件和 prompt 槽位渲染。
