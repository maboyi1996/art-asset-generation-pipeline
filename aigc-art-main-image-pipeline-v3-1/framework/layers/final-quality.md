...
检查 `artifact-manifest.json`、`production-source/main-image-production-table.md`、`deliverables/prompt-manifest.json` 和 `deliverables/main-image-review-table.docx` 是否符合 V3.1 输出契约。
