---
name: aigc-art-main-image-pipeline-v2-55
description: "Use this skill when Codex needs to read Chinese screenplays, novel drafts, episodic drama scripts, or project script files and produce story-faithful AIGC art main-image assets for characters, scenes, and props. V2.55 extends V2.54 by hard-blocking polluted character labels from dialogue prefixes, action/emotion/speech modifiers, combination phrases, and unresolved transferable titles before asset registration, while preserving B/C task coverage without changing middle-platform fields."
---

# AIGC Art Main Image Pipeline V2.55
