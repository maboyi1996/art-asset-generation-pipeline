---
name: aigc-art-main-image-pipeline-v2-52
description: "Use this skill when the user wants Codex to read Chinese screenplays, novel drafts, episodic drama scripts, or project script files and produce story-faithful AIGC art main-image assets for characters, scenes, and props. V2.52 extends V2.51 with global asset task generation rules that ensure all retained production assets, including B/C characters without project-level face anchors, enter global-task-draft before prompt generation."
---

# AIGC Art Main Image Pipeline V2.52
